...
const AddRoomFrom = ({setModalOpen, ...restProps}) => {
        ...
        const formik = useFormik({
            ...
            onSubmit: async (values) => {
                ...
                const resPic = await axios.putForm(`http://127.0.0.1:8000/api/upload?id=${data.id}&where=room`,
                    {'image': image},
                    {
                        headers: {
              ...
              <p>Info</p>
                ...
                <div>
                  ...
                  <div className="flex items-center justify-between pt-4">
                    ...
                    <div
                        className="flex flex-col items-center space-y-4 border-t border-slate-200 p-4 dark:border-navy-500 sm:flex-row sm:justify-between sm:space-y-0 sm:px-5">
                        <h2 className="text-lg font-medium tracking-wide text-slate-700 dark:text-navy-100">
                            {/* Room Setting */}
                        </h2>
                        <div className="flex justify-center space-x-2">
              ...
              Cancel
                            ...
                            >
                                {formik.isSubmitting ? (
                                    <>
                                        <div
                                            className="spinner h-7 w-7 animate-spin rounded-full border-[3px] border-primary/30 border-r-primary dark:border-accent/30 dark:border-r-accent"></div>
                                    </>
                                ) : (
                                    "Add Room"
                                )}
