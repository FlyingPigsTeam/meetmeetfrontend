                    ...
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        ...
                        <label class="block text-left">
                            ...
                            <span class="relative mt-1.5 flex">
                                ...
                                <button
                                    class="absolute right-1 flex h-full w-10 items-center justify-center text-slate-400 peer-focus:text-primary dark:text-navy-300 dark:peer-focus:text-accent"
                                ...
                                >
                                    ...
                                    {showPassword ?
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            className="h-4.5 w-4.5" viewBox="0 0 20 20"
                                            fill="none"
                                            strokeWidth={1.5}
                                            stroke="currentColor"
                                        >
