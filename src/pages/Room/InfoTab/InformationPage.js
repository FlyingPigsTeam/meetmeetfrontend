            ...
            <div className="text-left">
                <div
                    ...
                    {roomData.is_admin && (
                        <div className="flex justify-center space-x-2">
                            ...
                            <button onClick={() => navigate(`/room/${idroom}/info/edit`)}
                ...
                <span className="flex-grow">
                  ...
                  >
                    ...
                    />
                    <div
                        className="pointer-events-none absolute right-0 flex h-full w-10 items-center justify-center text-slate-400 peer-focus:text-primary dark:text-navy-300 dark:peer-focus:text-accent">
                      <svg
                          fill="currentColor"
                ...
                <span className="flex-grow">
                  <div
                      className="alert flex items-center justify-between rounded-lg bg-primary px-4 py-3 text-white dark:bg-accent sm:px-5">
