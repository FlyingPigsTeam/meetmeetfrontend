        ...
        >
          <div>
            <div class="flex space-x-2">
              <p class="text-xl font-medium text-slate-900 dark:text-navy-50">
                My Day
              </p>
            </div>
            ...
            >
              ...
              <div className="xl:col-start-5 sm:col-start-4 sm:col-end-6 ml-18 mt-2 sm:mt-0">
                <button
                  ...
                  class="badge space-x-2 h-9 w-28 bg-slate-150 text-slate-800 dark:bg-navy-500 dark:text-navy-100"
                >
                  <span>Edit Task</span>
                  <svg
                ...
                <button class="badge space-x-2 h-9 w-28 ml-3 bg-error text-white">
                  <span>Delete</span>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
